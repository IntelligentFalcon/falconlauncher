...
// import { backend, cn } from '@/lib/utils';
...
//     queryFn: () => backend('load_categorized_versions', filters),
//     select: (data) => {
...
//               id="liteloader"
//               className="w-5 h-5 accent-indigo-500 cursor-pointer"
//               checked={filters.lite_loader}
//               onChange={() =>
//                 setFilters((prev) => ({
//                   ...prev,
//                   lite_loader: !prev.lite_loader,
//                 }))
//               }
//             />
//             <label
...
//               id="neoforge"
//               className="w-5 h-5 accent-indigo-500 cursor-pointer"
//               checked={filters.neo_forge}
//               onChange={() =>
//                 setFilters((prev) => ({ ...prev, neo_forge: !prev.neo_forge }))
//               }
//             />
//             <label
//               htmlFor="neoforge"
