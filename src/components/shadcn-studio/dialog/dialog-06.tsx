      ...
      <DialogContent className="flex max-h-[min(600px,80vh)] flex-col gap-0 p-0 sm:max-w-md">
        <DialogHeader className="contents space-y-0 text-start">
          <ScrollArea className="flex max-h-full flex-col overflow-hidden">
            ...
            <DialogDescription render={<div className="p-6" />}><div className="[&_strong]:text-foreground space-y-4 [&_strong]:font-semibold">
        ...
        <DialogFooter className="flex-row items-center justify-end border-t px-6 py-4">
          <DialogClose render={<Button variant='outline' />}><ChevronLeftIcon />Back
                              </DialogClose>
