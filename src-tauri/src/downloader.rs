...
pub fn download_version(id: String) {
    ...
    match manifest {
        ...
        Some(val) => {
            ...
            download_libraries(&json["libraries"], &id);
...
fn download_libraries(libraries: &Value, version: &String) {
...
fn download_classifiers(classifiers: Option<&Value>, version: &String) {
